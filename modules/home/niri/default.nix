# Niri compositor config (KDL). Live-reloads on save.
# Ref: https://niri-wm.github.io/niri/Configuration:-Introduction
{ pkgs, ... }:

{
  xdg.configFile."niri/config.kdl".text = ''
    ...
    binds {
        ...
        // quit / lock (noctalia session panel handles real quit; Mod+M is a hard exit)
        Mod+M quit
